...
<section id="product-item">
    <div class="container">
        ...
        <div class="row">
            ...
            $sql_b = "SELECT `b`.`id_buku`, `b`.`judul`, `b`.`cover`, `p`.`penerbit` 
                    FROM `buku` `b` INNER JOIN `penerbit` `p` ON `b`.`id_penerbit` = `p`.`id_penerbit` 
    ...
    <div class="container">
        ...
        <div class="row mb-2">
            ...
            $sql_l = "SELECT `b`.`id_blog`, `b`.`judul`,
                    DATE_FORMAT(`b`.`tanggal`, '%d-%m-%Y'), `k`.`kategori_blog` 
            ...
            ?>
                <div class="col-md-6">
                    <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <div class="col-auto d-none d-lg-block"> <img src="images/blog.jpg" class="img-fluid" title="book title here">
                        </div>
                    </div>
                </div>
            <?php } ?>
