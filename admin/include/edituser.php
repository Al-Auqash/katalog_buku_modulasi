...
if (isset($_GET['data'])) {
  $id_user = $_GET['data'];
  $sql_d = "SELECT `nama`, `email`, `username`, `level` FROM `user` WHERE `id_user` = '$id_user'";
...
<section class="content">
  ...
  <div class="card card-info">
    ...
    <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-user&data=<?php echo $id_user ?>" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <select class="form-control" id="jurusan" name="level" value="<?php echo $level; ?>">
