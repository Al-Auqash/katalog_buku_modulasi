            ...
            <tr>
              ...
              <td align="center">
                ...
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
                            ...
                            'index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog; ?>&notif=hapusberhasil'" 
          ...
          if (!empty($katakunci_kategori)) {
            if ($halaman != 1) {
              echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog?katakunci=$katakunci_kategori&halaman=1'>First</a></li>";
              echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog?katakunci=$katakunci_kategori&halaman=$sebelum'>«</a></li>";
            }
            for ($i = 1; $i <= $jum_halaman; $i++) {
              if ($i > $halaman - 5 and $i < $halaman + 5) {
                if ($i != $halaman) {
                  echo "<li class='page-item'><a class='page-link' 
                            href='index.php?include=kategori-blog?katakunci=$katakunci_kategori&halaman=$i'>$i</a></li>";
                } else {
            ...
            if ($halaman != $jum_halaman) {
              echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog?katakunci=$katakunci_kategori&halaman=$setelah'>»</a></li>";
              echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-blog?katakunci=$katakunci_kategori&halaman=$jum_halaman'>Last</a></li>";
            }
          } else {
            if ($halaman != 1) {
              echo "<li class='page-item'><a class='page-link' 
