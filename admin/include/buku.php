    ...
    <div class="card-body">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          $sql_b .= " ORDER BY `kategori_buku` limit $posisi, $batas ";
            ...
            <tr>
              ...
              <td align="center">
                ...
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data
                        ...
                        'index.php?include=buku&aksi=hapus&data=<?php echo $id_buku; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>
              </td>
            </tr>
          <?php $no++;
          } ?>
        ...
        if ($jum_halaman == 0) {
          ...
          if (!empty($katakunci_buku)) {
            ...
            if ($halaman != $jum_halaman) {
              echo "<li class='page-item'><a class='page-link' href='index.php?include=buku?katakunci=$katakunci_buku&halaman=$setelah'>»</a></li>";
